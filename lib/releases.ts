...
export const releases: Release[] = [
  ...
  },
  {
    ...
    body: "分析タブ右上のダウンロードアイコンから、支出データをGoogleスプレッドシートに書き出せるようになりました。\n期間は「全期間 / 年単位 / 精算期間」から選択でき、メンバーごとの負担額・分割方法・タグ・メモも一緒に出力されます。\n初回はGoogle連携（drive.fileスコープ）が必要です。Pairboがこのアプリで作成したスプレッドシートのみ操作し、既存のドライブファイルには触れません。",
  },
];
